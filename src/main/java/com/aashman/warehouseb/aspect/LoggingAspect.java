package com.aashman.warehouseb.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(@org.springframework.stereotype.Repository *)" + " || within(@org.springframework.stereotype.Service *)" + " || within(@org.springframework.stereotype.Controller *)")
    public void springBeanPointcut() {
        // Method is empty as this is just a Pointcut
    }

    @Pointcut("within(com.aashman.warehouseb..*)" + " || within(com.aashman.warehouseb.service..*)" + " || within(com.aashman.warehouseb.controller..*)")
